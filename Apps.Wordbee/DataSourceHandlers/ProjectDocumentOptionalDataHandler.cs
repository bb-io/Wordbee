...
public class ProjectDocumentOptionalDataHandler : WordbeeInvocable, IAsyncDataSourceHandler
{
    private readonly ProjectDocumentOptionalRequest _request;

    public ProjectDocumentOptionalDataHandler(InvocationContext invocationContext,
        [ActionParameter] ProjectDocumentOptionalRequest request) : base(invocationContext)
    {
        _request = request;
    }
